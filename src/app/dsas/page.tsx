      ...
      {selectedTool && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg z-50">
            <h3 className="text-2xl font-semibold mb-4 text-current dark:text-white">
              {selectedTool.data_structure}
            </h3>
            <pre className="bg-gray-100 dark:bg-gray-900 dark:text-white p-4 rounded-md overflow-auto">
