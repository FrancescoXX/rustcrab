      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-evenly gap-8">
          {people.slice(0, 3).map((p, index) => (
            <div
              key={index}
              className="dark:bg-gray-900 bg-gray-200 p-6 rounded-lg shadow-lg transition duration-300 hover:shadow-xl hover:scale-105 w-full sm:w-1/2 md:w-1/4 lg:w-1/4 xl:w-1/4"
            >
