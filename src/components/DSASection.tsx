	...
	return (
		<section className='py-16 dark:bg-gray-800 bg-gray-200 rounded-md my-4'>
			<div className='container mx-auto px-4'>
				<h2 className='text-4xl font-bold mb-8 text-center text-current'>Data Structures in Rust</h2>
					...
					{dsas.slice(0, 3).map((dsa, index) => (
						...
						>
							<div className='flex flex-col items-center text-center'>
								<h3 className='text-2xl font-semibold mb-3 text-current'>{dsa.data_structure}</h3>
								<p className='dark:text-gray-400 text-gray-600 mb-4'>{dsa.description}</p>
								<button
